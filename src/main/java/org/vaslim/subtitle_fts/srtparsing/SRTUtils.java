...
public final class SRTUtils {
     ...
     */
    public static SubtitleDTO findSubtitle (ArrayList<SubtitleDTO> listSubtitles, long timeMillis) {
        ...
        for (int i = 0; i < listSubtitles.size(); i++) {
            SubtitleDTO sub = listSubtitles.get(i);
    ...
    /**
     * Metodo responsavel por buscar um Subtitle a partir de um {@link SubtitleDTO}, utilizando node<br>
     ...
     * @return
     */
    public static SubtitleDTO findSubtitle (final SubtitleDTO subtitle, long timeMillis) {
        if (subtitle == null) return null;

        SubtitleDTO subAux = subtitle;
     ...
     * @return
     */
    private static boolean inTime(final SubtitleDTO subtitle, long timeMillis) {
