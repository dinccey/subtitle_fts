...
public final class SRTParser {
     ...
     * @return
     */
    public static ArrayList<SubtitleDTO> getSubtitlesFromFile (String path) {
     ...
     * @return
     */
    public static ArrayList<SubtitleDTO> getSubtitlesFromFile (String path, boolean keepNewlinesEscape) {
     ...
     * @return
     */
    public static ArrayList<SubtitleDTO> getSubtitlesFromFile (String path, boolean keepNewlinesEscape, boolean usingNodes) {

        ArrayList<SubtitleDTO> subtitles = null;
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(new FileInputStream(path), DEFAULT_CHARSET))) {
            ...
            while (bufferedReader.ready()) {
                ...
                if (usingNodes) {
                    subtitle.nextSubtitle = new SubtitleDTO();
